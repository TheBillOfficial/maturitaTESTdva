<?php
// source: Z:\Programovani\Projekty\cistyNETTE\app/config/config.neon 
// source: Z:\Programovani\Projekty\cistyNETTE\app/config/config.local.neon 

class Container_c06d6f706a extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'Z:\Programovani\Projekty\cistyNETTE\app',
			'wwwDir' => 'Z:\Programovani\Projekty\cistyNETTE\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'Z:\Programovani\Projekty\cistyNETTE\app/../temp',
		];
	}
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'Z:\Programovani\Projekty\cistyNETTE\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'
		));
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('Z:\Programovani\Projekty\cistyNETTE\app/../temp/cache');
		return $service;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_c06d6f706a $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('Z:\Programovani\Projekty\cistyNETTE\app/../temp/cache/latte');
